...
#Скрипт для отпавки ETH из кошельков privatzk.txt через оффиц.мост ZK-ETH. Отправляет транзакции с рандомным числом ETH в заданном диапазоне с задержкой 3-8сек. 
